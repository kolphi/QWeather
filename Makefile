...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Mi 11. Jän 22:13:37 2012
...
LINK          = g++
LFLAGS        = -Wl,-rpath-link,/usr/lib -Wl,-rpath,D:/usr/lib
LIBS          = $(SUBLIBS)  -LC:/MADDE/0.7.48/sysroots/fremantle-arm-sysroot-20.2010.36-2-slim/usr/lib -L/usr/lib -lQtLocation -lQtGui -L/usr/X11R6/lib -lQtDBus -lQtXml -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		weatherpull.cpp moc/moc_mainwindow.cpp \
		rcc/qrc_res.cpp
OBJECTS       = obj/main.o \
		obj/mainwindow.o \
		obj/weatherpull.o \
